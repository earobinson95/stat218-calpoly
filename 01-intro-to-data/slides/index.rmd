...
+ Introduction Questionnaire *(due Wednesday, 9/21, at 8pm)*
...
`r fa_i("chart-bar")` Check *Activity 1: Martian Alphabet* for completion
`r fa_i("chart-bar")` Set up RStudio Cloud
`r fa_i("chart_bar")` Lab 1: Welcome to RStudio Cloud!

---
class:primary
# TO DO

+ Introduction Questionnaire *(due tonight, 9/21, at 8pm)*
