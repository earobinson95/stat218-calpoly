...
<!-- + Introduce yourselves again (with year + major + comfort food/hobby) -->
...
`r fa_i("chart-bar")` Check *Activity 1: Martian Alphabet*

`r fa_i("chart-bar")` Introduce Instructional Student Assistant

`r fa_i("chart-bar")` Set up RStudio Cloud & Introduction to R

`r fa_i("chart_bar")` Lab 1: Welcome to RStudio Cloud!

`r fa_i("chart_bar")` Beginning your midterm project
...
+ Lab 1: Welcome to RStudio Cloud
  ...
  + *individual completion: due Monday, 9/26 at 2pm* 
