...
This is an Quarto document. Quarto is a simple formatting syntax for authoring HTML, PDF, and Microsoft Word documents. 
...
The data are located in the *data* folder of your project. To load in the data, we need to specify the "path" to the data, or where R needs to look 
for the data. I like to use the `here()` function from the **here** package to read in data, because I find the format intuitive. I'll walk you through what the code below is doing. 
