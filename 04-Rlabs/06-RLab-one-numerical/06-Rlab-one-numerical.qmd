...
# write code to view top 6 rows here.
```
...
```{r boxplot}
# copy code from above and modify to create a boxplot
```
...
::: callout-note
## Distribution of Sample Means (i.e., Null Distribution)
...
+ Standard Deviation (aka Standard Error): your answer
...
10. Using the output above and an $\alpha = 0.05$, make a decision (Reject the Null/Fail to Reject the Null) regarding your hypothesis test.

Your answer goes here.

11. Write a conclusion in context of the problem. Make sure to state your significance level, observed T test statistic, degrees of freedom, and p-value in your conclusion.
...
15. What do you notice about the 99% confidence interval compared to the 95% confidence interval? Is it wider? narrower? the same?

16. Based on your 99% confidence interval do you believe you would have evidence (at an $\alpha = 0.01$ cutoff) to conclude the mean hours worked in a week for all Americans differs from 40 hours? *Hint: think about (1) where does 40 fall in regards to the confidence interval? (2) what is your p-value from Q9?*
