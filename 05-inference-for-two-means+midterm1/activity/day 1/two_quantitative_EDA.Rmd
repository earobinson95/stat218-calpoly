...
movies <- read_csv("Movies2016.csv")
```
...
**RemindersL** Fill out in context of this problem (See variable names in the table above).
...
8. For each type of plot, how would you include a categorical variable in the plot? 
...
9. How would you describe the shape of the distribution of PG movie budgets? 

\vspace{1in}

10. How would you describe the shape of the distribution of R movie budgets? 

\vspace{0.8in}

11. Visually, does it appear that there are outliers in either of these groups?
...
12. Why are the boxplots stacked side-by-side horizontally? What part of the `R` code does this?
...
13. How was the previous code changed to stack the boxplots side-by-side vertically? 

\vspace{0.8in}
 
14. Which orientation do you prefer?
