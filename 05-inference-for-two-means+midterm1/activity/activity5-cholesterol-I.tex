...
participants on the corn flake \texttt{CORNFLK} diet and participants on
the oat bran \texttt{OATBRAN} diet.
...
\item
  ...
  corn flake diet. \emph{Use appropriate notation.}
\end{enumerate}
...
\item
  ...
  bran diet. \emph{Use appropriate notation.}
\end{enumerate}
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/facet-hist-1.pdf}
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/one-box-1.pdf}
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/horizontal-box-1.pdf}
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/vertical-box-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cholesterol\_data\_long }\SpecialCharTok{\%\textgreater{}\%} 
  
  \FunctionTok{specify}\NormalTok{(}\AttributeTok{response =}\NormalTok{ \_\_\_\_\_\_\_\_\_\_\_\_\_, }\AttributeTok{explanatory =}\NormalTok{ \_\_\_\_\_\_\_\_\_\_\_\_\_) }\SpecialCharTok{\%\textgreater{}\%} 
  
  \FunctionTok{hypothesise}\NormalTok{(}\AttributeTok{null =}\NormalTok{ \_\_\_\_\_\_\_\_\_\_\_\_\_) }\SpecialCharTok{\%\textgreater{}\%} 
  
  \FunctionTok{generate}\NormalTok{(}\AttributeTok{reps =}\NormalTok{ \_\_\_\_\_\_\_\_\_\_\_\_\_, }\AttributeTok{type =}\NormalTok{ \_\_\_\_\_\_\_\_\_\_\_\_\_) }\SpecialCharTok{\%\textgreater{}\%} 
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/null-dist-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs\_diff }\OtherTok{\textless{}{-}}\NormalTok{ cholesterol\_data\_long }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{specify}\NormalTok{(}\AttributeTok{response =}\NormalTok{ Cholesterol, }\AttributeTok{explanatory =}\NormalTok{ Diet) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{calculate}\NormalTok{(}\AttributeTok{stat =} \StringTok{"diff in means"}\NormalTok{, }
            \AttributeTok{order =} \FunctionTok{c}\NormalTok{(}\StringTok{"CORNFLK"}\NormalTok{, }\StringTok{"OATBRAN"}\NormalTok{)}
\NormalTok{            )}

\FunctionTok{get\_p\_value}\NormalTok{(null\_dist, }\AttributeTok{obs\_stat =}\NormalTok{ obs\_diff, }\AttributeTok{direction =} \StringTok{"two{-}sided"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Based off the simulation, what is the p-value for your hypothesis
  test. Based off of this p-value, write a conclusion to the hypothesis
  test.
\end{enumerate}
...
\tightlist
\item
  If we would have concluded evidence of a relationship between diet and
  cholesterol levels, would we have been able to say diet causes changes
  in cholesterol levels? Explain.
\end{enumerate}
...
{\centering \includegraphics{activity5-cholesterol-I_files/figure-pdf/t-dist-1.pdf}
...
\tightlist
\item
  \texttt{formula} response \textasciitilde{} explanatory
\item
  \texttt{order} group 1 - group 2 (specified as (``group 1'', ``group
  2''))
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{infer}\SpecialCharTok{::}\FunctionTok{t\_test}\NormalTok{(cholesterol\_data\_long,}
       \AttributeTok{formula =}\NormalTok{ Cholesterol }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Diet,}
