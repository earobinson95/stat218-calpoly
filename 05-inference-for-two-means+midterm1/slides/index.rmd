...
$\mu_{group 1} - \mu_{group 2}$: The true mean difference between *RESPONSE VARIABLE* between *GROUP 1* and *GROUP 2* for the population.


**Null:** The true difference in mean *RESPONSE VARIABLE* between *GROUP 1* and *GROUP 2* for the population is equal to 0 (There is no difference between the two groups) $(H_O: \mu_{group 1} - \mu_{group 2} = 0)$


**Alternative:** The true difference in mean *RESPONSE VARIABLE* between *GROUP 1* and *GROUP 2* for the population is not equal to 0 (There is a difference between the two groups) $(H_A: \mu_{group 1} - \mu_{group 2} \ne 0)$
