...
**Part 2: Inference for Paired Differences**
...
1. Based on the p-value you obtained from Thursday's activity, do you believe 0 is a plausible value for $\mu_{\text{CORNFLK}} - \mu_{\text{OATBRAN}}$? 
