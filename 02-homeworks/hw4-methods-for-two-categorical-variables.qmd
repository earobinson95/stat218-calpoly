  ...
  pdf:
    ...
    include-in-header:
      text: |
          ...
          \pagestyle{fancy}
          \fancyhf{}
          \fancyhead[R]{Homework 4: Fatal Injuries in the Iliad}
          \fancyfoot[C]{\thepage}
  docx:
    toc: false
execute:
...
2.  How would you describe the position of this bar plot? \hspace{0.1in} Filled \hspace{0.1in} Stacked \hspace{0.1in} Dodged
...
3.  Based on the plot does there appear to be an association between the variables? Explain your answer.
...
|               | Body | Head/neck | Limb | Unknown | TOTAL |
|---------------|------|-----------|------|---------|-------|
| **Fatal**     |      |           |      |         |       |
| **Not Fatal** |      |           |      |         |       |
| **TOTAL**     |      |           |      |         | 184   |
...
12. Is it appropriate us the Chi-square distribution to test our research question?
...
19. Write a conclusion and make sure to include your evidence.

\vspace{2in}

20. Based on the study design and data collection method, what conclusions can we draw regarding the relationship between injury location and fatal outcomes? Can these findings be generalized to a broader population? Explain why or why not.
