...
#| fig-align: center
#| out-width: 70%
knitr::include_graphics("01-images/parameter-vs-statistic.PNG")
```
...
+-----------------------------------+-----------------------------------------------------------------------------------------------------------------------+
| Research Question                 | Is there statistical evidence of sex discrimination against females?                                               |
+-----------------------------------+-----------------------------------------------------------------------------------------------------------------------+
...
+ Conclusion: We do have evidence that all 10-month-old infants prefer the helper toy. 
...
11. How do we interpret the meaning of the lower and upper endpoints when the outcomes are measured as proportions instead of as counts?
...
12.	Identify the lower and upper endpoints that separate close to the bottom 2.5% and the top 2.5% of the outcomes.
...
13.	Start with the **point estimate**, $\hat \pi$:

\vspace{0.2in}

14.	Calculate the **standard error** associated with this point estimate:

$$\sqrt{\frac{\hat\pi(1-\hat\pi)}{n}} =$$


15.	Calculate the **margin of error**: This is defined as 1.96 standard errors for a 95\% confidence interval.  *(This is discussed more on the next page)*.

$$1.96 \times \sqrt{\frac{\hat\pi(1-\hat\pi)}{n}} =$$

16.	Find the **endpoints** of the confidence interval:
...
17.	What is the 95% confidence interval based on the normal theory approach for this problem?

\vspace{0.5in}


18.	What is the interpretation of this confidence interval?
...
19. Check this condition for the Acupuncture example.  Does the Wald interval seem to be appropriate here?
