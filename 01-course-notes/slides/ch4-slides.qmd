...
- **Expected Counts**:
  ...
  - For **Independence Test**: Based on marginal totals from the contingency table.
...
- **Misconception**: "Test of independence is for small sample sizes."
  - **Clarification**: Both tests require sufficiently large expected counts in each category (commonly at least 5).
