...
exam_days <- filter(Cal, category == "Exam") %>%
  mutate(topic = c("Midterm Exam 1 (In Class)", "Midterm Exam 2 (In Class)",  "Final Exam (Section 06) at 4:10-7:00 PM", "Final Exam (Section 05) at 1:10-4:00 PM"),
         time = c("In Class", "In Class", "1:10-4:00 PM", "4:10-7:00 PM")) %>%
  rowwise() %>%
...
* Printed activities will be provided for you on Monday, with PDF files posted on Canvas
...
grade.
* Potential individual midterm exam questions will be posted on canvas.
...
* Potential final exam questions will be posted on canvas.
