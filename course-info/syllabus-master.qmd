...
Office: 25-103 (Faculty Offices East) | Office Hours (online): [Schedule here](https://calendly.com/drvanderplas/officehours) 
...
class_cal <- Cal %>% 
  ...
  scale_fill_manual(values=c("Class Day"="purple", 
                    ...
                    breaks=c("Semester", "Cal Poly Holiday", "Class Day","Project"))
# class_cal
