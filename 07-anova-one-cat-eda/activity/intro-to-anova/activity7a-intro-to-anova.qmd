...
author: "Your Name: ____________________"
format: html
# format: pdf
# format: docx
editor: visual
...
9.  Which genre has the largest sample size? What is the formula for the standard deviation of a mean? What effect does sample size have on the standard deviation?
...
13. Draw horizontal lines on the plot above, indicating which values are being compared with calculating the SSE.
